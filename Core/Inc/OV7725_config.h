...
#ifndef CAMERA_H7_OV7725_CONFIG_H
#define CAMERA_H7_OV7725_CONFIG_H
...
const uint8_t ov7725_init_reg_tb1[][2]=
        {
                ...
                {COM7,      0x46}, // VGA 565
                {HSTART,    0x23}, // Sensor VGA Start Point
                {HSIZE,     0xA0}, // Sensor VGA
                {VSTRT,     0x07}, // Sensor VGA Start Point
                {VSIZE,     0xF0}, // Sensor VGA
                {HREF,      0x00},
//                {HOutSize,  0x18}, // Output Width 96
                {HOutSize,  0x28}, // Output Width 160
//                {VOutSize,  0x12}, // Output Height 72
                {VOutSize,  0x3C}, // Output Height 240
...
#endif //CAMERA_H7_OV7725_CONFIG_H
